...
class Player(BasePlayer):
    ...
    q7 = models.IntegerField(choices=[[1,'Tidak diketahui'],[2,'20% s.d 40% dari total seluruh wajib pajak Nusa Makmur'],[3,'20% s.d 40% dari total seluruh periode pelaporan pajak'],[4,'20% s.d. 40% untuk masing-masing wajib pajak pada setiap pelaporan pajaknya']], label='7) Berapa probabilitas pemeriksaan yang dilakukan oleh Nusa Makmur?')
